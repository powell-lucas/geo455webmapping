var mymap = L.map('map').setView([43.06729, -89.418123], 8);
...
fetch('lab8_data/wi_il_gcs.json')
  ...
  .then(function(wi_ilData) {
    ...
    // Create migration layer AFTER map is fully ready
    window.commuteLayer = new L.migrationLayer({
      map: mymap,
      data: data,
      pulseRadius: 30,
      pulseBorderWidth: 3,
